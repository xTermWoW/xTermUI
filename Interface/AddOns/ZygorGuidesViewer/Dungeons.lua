...
local hardcoded_dungeons = {
	...
	["e_1178"]  = {expansionLevel=7, minLevel=120, min_ilevel=310, difficulty=23, name="Operation: Mechagon", nomythicplus=true },
...
setmetatable(Dungeons,{
	__index=function(t,id)
		...
		if hardcoded_dungeons[id] then
			...
			name,expansionLevel,minLevel,min_ilevel,difficulty,nomythicplus = d.name,d.expansionLevel,d.minLevel,d.min_ilevel,d.difficulty,d.nomythicplus
		else
		...
		if name and typeID~=4 then
			...
			dungeon.nomythicplus = nomythicplus
