...
function Appraiser:GetSellPriceForStacksize(mode)
	...
	if mode=="unit" then
		if selling_price_buy*stacksize> ah_sell_cap then selling_price_buy = math.floor(ah_sell_cap/stacksize) end
		if selling_price_bid*stacksize> ah_sell_cap then selling_price_bid = math.floor(ah_sell_cap/stacksize) end
	end
