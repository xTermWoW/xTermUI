...
-- #GLOBALS BINDING_HEADER_ZYGORGUIDESATIONBAR,CreateFrame,CreateMacro,EditMacro,GameTooltip,GetMacroBody,GetMacroIndexByName,GetMacroInfo,GetPetActionInfo,GetSpellInfo,InCombatLockdown,SetMacroItem,SetMacroSpell,UIParent,ZygorGuidesViewer
