...
-- #GLOBALS _,C_Map,CreateFrame,GetAddOnInfo,GetContainerItemInfo,GetContainerItemLink,GetContainerNumSlots,GetItemStats,GetLocale,GetMinimapZoneText,GetNumAddOns,GetPetActionInfo,GetProfessionInfo,GetProfessions,GetRealZoneText,GetSpecialization,GetSpecializationInfo,GetSpellInfo,GetSubZoneText,GetZoneText,HideUIPanel,InterfaceOptionsFrame,LibRover,LibStub,Screenshot,ShowUIPanel,UIParent,UISpecialFrames,UnitBuff,UnitClass,UnitDebuff,UnitFactionGroup,UnitName,UnitRace,ZygorGuidesViewer_DumpFrameReport,ZygorGuidesViewerMaintenanceFrame
