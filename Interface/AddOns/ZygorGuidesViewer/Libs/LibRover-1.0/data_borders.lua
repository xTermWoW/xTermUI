...
data.basenodes.borders = {
	...
	-- Zandalar
		...
		"Dazar'alor/0 49.89,68.89 -x- Dazar'alor/0 49.89,64.13 {fac:H}",
		"Dazar'alor/0 51.69,21.33 -x- Dazar'alor/0 54.19,25.33 {fac:H}",
		"Dazar'alor/0 41.91,26.78 -x- Dazar'alor/0 43.68,29.50 {fac:H}",
		"Dazar'alor/0 45.96,61.00", "Dazar'alor/0 53.92,61.22 {fac:H}", -- around wall
