...
if ZGV:DoMutex("InvasionDailiesALEGION") then return end
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Legion (100-110)\\Legion Intro",{
	...
	step
		...
		Assault the Broken Shore |scenariostage 1 |goto Broken Shore/0 49.36,71.79 |q 42740 |only if havequest(42740) or completedq(42740)
		Assault the Broken Shore |scenariostage 1 |goto Broken Shore/0 49.36,71.79 |q 43806 |only if havequest(43806) or completedq(43806)
	...
	step
		Follow the path |goto 83.94,30.69 < 15 |only if walking
		Go through the doorway |goto 81.55,35.60 < 15 |only if walking
		click Demon Portal##246707
