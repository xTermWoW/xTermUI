...
Loot and Equip a Trainee's Sword |q 30038/1 |goto 56.87,19.68
only if Pandaren Warrior
step
talk Master Shang Xi##53566
turnin The Lesson of the Iron Bough##30038 |goto 56.66,18.20
accept The Lesson of the Sandy Fist##29406 |next "next01" |goto 56.66,18.20
only if Pandaren Warrior
step
talk Master Shang Xi##53566
...
Loot and Equip a Trainee's Crossbow |q 30034/1 |goto 56.87,19.68
only if Pandaren Hunter
step
talk Master Shang Xi##53566
...
Loot and Equip the Mainhand Dagger |q 30036/1 |goto 56.87,19.68
only if Pandaren Rogue
step
...
Loot and Equip a Trainee's Mace |q 30035/1 |goto 56.87,19.68
only if Pandaren Priest
step
...
Loot and Equip a Trainee's Axe |q 30037/1 |goto 56.87,19.68
only if Pandaren Shaman
step
...
Loot and Equip a Trainee's Spellblade |q 30033/1 |goto 56.87,19.68
only if Pandaren Mage
step
...
accept The Lesson of the Sandy Fist##29406 |goto 56.66,18.20 |next "next01"
only if Pandaren Mage
step
talk Master Shang Xi##53566
...
step
click Weapon Rack##210016
use Trainee's Handwrap##77279
use Trainee's Handwrap##77278
Loot and Equip the Trainee's Handwrap |q 30027/1 |goto 56.87,19.68
Loot and Equip a second Trainee's Handwrap |q 30027/2 |goto 56.87,19.68
only if Pandaren Monk
step
talk Master Shang Xi##53566
...
step
use Sun Pearl##73791
Coax Shu, the Water Spirit |q 29678/2 |goto 79.78,39.06
step
...
step
Ride the Cart to the Dai-Lo Farmstead |goto 70.68,65.85 < 10 |q 29680
step
...
step
Ride the Cart to the Temple of Five Dawns |goto 51.96,58.58 < 10 |q 29775
step
talk Master Shang Xi##54786
|tip Inside the building.
...
step
Return to Mandori Village |goto 49.16,58.55 < 10 |q 29791
step
...
Start Carrying a Sailor |havebuff 135928 |goto 38.52,86.34 |q 29794
step
Rescue #3# Injured Sailors |q 29794/1  |goto 42.14,86.70
Click here to Get Another Sailor |next "Rescue_Injured_Sailors" |confirm
step
...
step
Ride the Cart to Mandori Village |goto 51.62,59.07 < 10 |q 29800
step
