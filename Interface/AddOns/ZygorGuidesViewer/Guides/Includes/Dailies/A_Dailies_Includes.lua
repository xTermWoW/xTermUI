...
ZygorGuidesViewer:RegisterInclude("BFA_Choose_World_Quests",[[
		...
		'|confirm |next "Rustbolt_Resistance_WQ" |condition (readyq(55348) or readyq(55348)) and not ZGV.WorldQuests:QuestsQueued()
...
ZygorGuidesViewer:RegisterInclude("BFA_World_Quest_Emissaries",[[
	...
	label "Rustbolt_Resistance_WQ"
		turnin Supplies from the Rustbolt Resistance##55348
