...
ZygorGuidesViewer:RegisterInclude("Argus_Invasion_Illidan",[[
		...
		talk Illidan Stormrage##126408 |goto Mac'Aree/3 47.31,19.56 |only if (ZGV.CurrentMapID==882 or ZGV.CurrentMapID==883 or ZGV.CurrentMapID==884)
...
ZygorGuidesViewer:RegisterInclude("Argus_Invasion_Turalyon",[[
		...
		talk High Exarch Turalyon##124312 |goto Mac'Aree/3 45.87,23.93 |only if (ZGV.CurrentMapID==882 or ZGV.CurrentMapID==883 or ZGV.CurrentMapID==884)
...
ZygorGuidesViewer:RegisterInclude("Argus_Scouting_Map",[[
		...
		clicknpc Scouting Map##127476 |goto Mac'Aree/4 68.13,57.18 |only if (ZGV.CurrentMapID==882 or ZGV.CurrentMapID==883 or ZGV.CurrentMapID==884)
