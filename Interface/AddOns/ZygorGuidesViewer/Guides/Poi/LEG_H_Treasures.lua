...
spot="Highmountain/29 40.63,50.23",
item=138783,
quest=40509,
steps=[[
step
...
currency="OR",
treasure=[[Treasure Chest]],
spot="Highmountain/31 43.58,25.10",
item=138783,
quest=40478,
steps=[[
step
...
currency="OR",
quest=40475,
condition=[[only if havequest(39784) or completedq(39784)]],
steps=[[
step
