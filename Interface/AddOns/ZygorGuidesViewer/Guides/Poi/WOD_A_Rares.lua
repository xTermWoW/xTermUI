...
item=120945,
quest=37397,
condition=[[only if havequest(36677) or havequest(36694) or havequest(38193) or havequest(38180)]],
steps=[[
step
...
item=109074,
quest=35847,
condition=[[only if havequest(35032) or completedq(35032)]],
steps=[[
step
...
rare=[[TEST POI]],
level=20,
spot="Darkshore 53,26",
currency="AC",
item=120945,
quest=37384,
steps=[[
step
'goal pre1 |goto Darkshore/0 50.67,19.41
'goal pre2 |goto Darkshore/0 50.31,20.04
'goal pre3 |goto Darkshore/0 50.83,20.26
'goal 2 noway c |goto Darkshore/0 53,26 < 50 |future
]],
},
}
