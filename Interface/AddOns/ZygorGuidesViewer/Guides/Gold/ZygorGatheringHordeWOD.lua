...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Abyssal Gulper Eel Flesh/Crescent Saberfish Flesh (Garrison)",{
	...
	description="This guide will walk you through fishing Abyssal Gulper Eel Flesh and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackwater Whiptail Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Blackwater Whiptail Flesh and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blind Lake Sturgeon Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Blind Lake Sturgeon Flesh and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Crescent Saberfish Flesh from open water.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fat Sleeper Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Fat Sleeper Flesh and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fire Ammonite Tentacle/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Fire Ammonite Tentacle and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jawless Skulker Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Jawless Skulker Flesh and Crescent Saberfish Flesh from your garrison waters.",
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sea Scorpion Segment/Crescent Saberfish (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
	description="This guide will walk you through fishing Sea Scorpion Segment and Crescent Saberfish Flesh from your garrison waters.",
