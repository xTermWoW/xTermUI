...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Stonehide Leather",{
	meta={goldtype="route",skillreq={legion_skinning=1},levelreq=100},
	items={{124113,420}},
	maps={"Stormheim"},
	},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Aethril",{
	meta={goldtype="route",skillreq={legion_herbalism=1},levelreq=100},
	items={{124101,420}},
	maps={"Azsuna"},
	},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Starlight Rose",{
	meta={goldtype="route",skillreq={legion_herbalism=1},levelreq=110},
	items={{124105,420}},
	maps={"Suramar"},
	},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Leystone Ore & Felslate (Mining Route)",{
	meta={goldtype="route",skillreq={legion_mining=1},levelreq=100},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Highmountain Salmon",{
	meta={goldtype="route",skillreq={legion_fishing=1},levelreq=100},
	items={{124109,60}},
	maps={"Highmountain"},
	},[[
	step
