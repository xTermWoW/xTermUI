--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6343 2019-07-05 18:32:40Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6343 $","5.12.DEV.", 'auctioneer', 'libs')
